...
rm $INSTALL_FILE       && \
$INSTALL_DIR/database/runInstaller -silent -waitforcompletion -responsefile $INSTALL_DIR/$INSTALL_RSP -ignoresysprereqs -ignoreprereq && \
rm -rf $ORACLE_HOME/OPatch && \
unzip $INSTALL_DIR/$OPATCH_FILE -d $ORACLE_HOME/
